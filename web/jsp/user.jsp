...
<div class="modal fade" id="addAccount" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="#" style="padding: 30px;" enctype="multipart/form-data">
                    <div class="form-group ">
                        <label for="acId" class="control-label">用户id：</label>
                        <input type="text" class="form-control" id="acId" required value="栋哥">
                    </div>
                    <div class="form-group ">
                        <label for="acName" class="control-label">用户名：</label>
                        <input type="text" class="form-control" id="acName" required pattern="^[a-zA-Z]\w{4,10}$" placeholder="以字母开头的字符串">
                    </div>
                    <div class="form-group ">
                        <label for="acHead" class="control-label">用户头像：</label>
                        <input type="file" class="form-control" id="acHead" required >
                    </div>
                    <div class="form-group">
